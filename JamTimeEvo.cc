...
int main(){
	...
	double di=0.125;    //initial density
	double dm=0.145;    //max density 
...
//	std::ofstream resultnav(filename10.c_str());
	...
	/*	filename1="VelLabelTime-l"+ssl.str()+"k-v"+sss.str()+"-p0.1-d"+ss1.str()+"-1.txt";
		...
		filename7="JamLengthTimeEvo-l"+ssl.str()+"k-v"+sss.str()+"-p0.1-d"+ss1.str()+"-cut3.txt";
		std::ofstream resultj3(filename7.c_str());   //initialize file
		
		filename8="NumCarsInJamTimeEvo-l"+ssl.str()+"k-v"+sss.str()+"-p0.1-d"+ss1.str()+"-cut3.txt";
		std::ofstream resultn3(filename8.c_str());   //initialize file
		
		
		filename5="JamLengthTimeEvo-l"+ssl.str()+"k-v"+sss.str()+"-p0.1-d"+ss1.str()+"-cut4.txt";
		std::ofstream resultj4(filename5.c_str());   //initialize file
		
		filename6="NumCarsInJamTimeEvo-l"+ssl.str()+"k-v"+sss.str()+"-p0.1-d"+ss1.str()+"-cut4.txt";
		std::ofstream resultn4(filename6.c_str());   //initialize file
